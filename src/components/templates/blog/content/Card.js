                ...
                <div className={`${styles.blog_item}`}>
                    <Link href="">
                        ...
                        <div className={`${styles.title}`}>
                            ...
                            <h4 className="font-16 text-overflow-1 h4"> ارز دیجیتال چیست و چگونه استخراج میشود؟</h4>
                        </div>
                    </Link>
                </div>
            </div>
        ...
        <div className={`${styles.swiper_slide}`}>
            <div className={`${styles.blog_item}`}>
                <Link href={`/blog-detail/${post.id}`}>
                    <div className={`${styles.image}`}>
                        <img src={post.image || "/images/blog-2.jpg"} alt={post.title} className="img-fluid" />
                    </div>
                    <div className={`${styles.title}`}>
                        <div className="d-flex align-items-center justify-content-between">
                            <div className={`${styles.title_item}`}>
                        ...
                        <h4 className="font-16 text-overflow-1 h4">{post.title}</h4>
                    </div>
                </Link>
            </div>
        </div>
